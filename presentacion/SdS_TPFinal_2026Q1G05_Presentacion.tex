  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{itemize}
        ...
        \item Quedan $\approx 1.4$ agentes por corrida sin evacuar: \emph{livelock} contra
          muros (boca de escalera de la planta alta, portón de salida).
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[c]{Conclusiones}
  \begin{itemize}
    ...
    \item La \textbf{ocupación del kiosco crece al acortar la ventana de llegada} y, a
      ...
      rango explorado.
    \item Límite conocido: $\approx 1.4$ agentes por corrida no evacúan por el \emph{livelock}
      de contacto con muros del modelo de fuerzas (reducido con el contacto al núcleo duro,
      no eliminado).
  \end{itemize}
\end{frame}
