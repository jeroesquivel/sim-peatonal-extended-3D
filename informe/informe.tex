...
($1.4$, $1.6$ y $1.4$ para $N=40$, $80$ y $120$). La inspección de los cuadros finales muestra
el \emph{livelock} de contacto con muros descripto en la Sección~\ref{sec:impl}: un agente
aislado, cuya dirección deseada queda casi paralela a un muro, alterna entre el escape de
contacto y la atracción al objetivo, con velocidad instantánea $\sim v_d$ pero desplazamiento
neto nulo. Tras endurecer el criterio de contacto, el atasco ya no ocurre en las puertas de
aula: el remanente aparece en la boca de la escalera de la planta alta (el agente oscila contra
la baranda del hueco sin iniciar el descenso) y, en menor medida, en la jamba del portón de
salida de la planta baja. Es un agente aislado por punto de atasco, no congestión de la
escalera. (En una de las quince corridas el ``rezagado'' era simplemente el último agente en
tránsito hacia la salida, un caso borde del criterio operativo de evacuado.)
...
\begin{itemize}
  ...
  \item En promedio $1.4$ agentes por corrida no evacúan, por el \emph{livelock} de contacto
  con muros del modelo de fuerzas; el endurecimiento del criterio de contacto lo eliminó de las
  puertas de aula, pero persiste en la boca de la escalera y en el portón de salida. Es un
  límite conocido, reducido pero no eliminado.
\end{itemize}
